...
saral = findViewById(R.id.saral);
        ...
        if(settings.getString("lead_phase","").equalsIgnoreCase("HAREDA_PHASE3")||settings.getString("lead_phase","").equalsIgnoreCase("HAREDA_PHASE4")||settings.getString("lead_phase","").equalsIgnoreCase("GALO_PHASE1") || settings.getString("lead_phase", "").equalsIgnoreCase("MSEDCL_PHASE1")) {
