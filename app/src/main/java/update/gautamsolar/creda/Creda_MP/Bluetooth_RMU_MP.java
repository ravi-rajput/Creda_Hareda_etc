...
import update.gautamsolar.creda.BluetoothSPP.Search_Adapter;
import update.gautamsolar.creda.BluetoothSPP.Search_Model;
...
public class Bluetooth_RMU_MP extends AppCompatActivity {
    ...
    private Bluetooth_RMU_MP.ConnectedThread mConnectedThread;
    ...
    String rmu_mp_api,eng_id,sregnnumber, sbenifname, sfname, scontact, svillage, sblock, spumpType, old_rmu;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bluetooth__rmu__mp);
        ...
        FatherID = (TextView) findViewById(R.id.fatheridebublurmump);
        BenificiaryName = (TextView) findViewById(R.id.benificiaryidesublurmump);
        Block = (TextView) findViewById(R.id.blockidesublurmump);

        VillageID = (TextView) findViewById(R.id.villageidebublurmump);
        ContactId = (TextView) findViewById(R.id.contactidebublurmump);
        ...
        RmuImage = (LinearLayout) findViewById(R.id.rmu_image_clickurmump);
        ...
        Localdialog = new Dialog(Bluetooth_RMU_MP.this); // Context, this, etc.
        dialog = new Dialog(Bluetooth_RMU_MP.this); // Context, this, etc.
        ...
        NewRmuNou = (EditText) findViewById(R.id.textrmunonewublurmump);
        NewRmuNou.setFocusable(false);
        RmuimageOneU = (ImageView) findViewById(R.id.imagermu_oneublurmump);
        new Bluetooth_RMU_MP.ConnectBT().execute(); //Call the class to connect
        sensorView0 = (TextView) findViewById(R.id.sensorView0ublurmump);
        location = findViewById(R.id.textublurmump);
        send = findViewById(R.id.sendublurmump);
        ...
        mRecyclerView = findViewById(R.id.recycler_listublurmump);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ConnectivityManager cm = (ConnectivityManager) Bluetooth_RMU_MP.this.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//                        savelocal(device_id);
                        ...
                        e.printStackTrace();
                        Toast.makeText(Bluetooth_RMU_MP.this, "ERROR", Toast.LENGTH_SHORT).show();
                    }
...
//                    });
        ...
        protected void onPostExecute(Void result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (!ConnectSuccess) {
                ...
                msg("Connected.");
                mConnectedThread = new Bluetooth_RMU_MP.ConnectedThread(btSocket);
    ...
    public void UploadRmu(String Api_Rmu) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, rmu_mp_api, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (message.equals("false")) {
                        ...
                        dialog.findViewById(R.id.clickmedismiss).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent i = new Intent(Bluetooth_RMU_MP.this, UploadAll.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("Engineer_contact",Engineer_Contact);
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(Bluetooth_RMU_MP.this);
                    }
                })
...
/*
    ...
    public void save_local() {
        ...
        rmu_table_mp.NewRMuNO = String.valueOf(NewRmuNou.getText().toString());
        ...
        rmu_table_mp.Eng_Contact_rmu = Engineer_Contact;
        ...
        Localdialog.findViewById(R.id.clickmedismissf).setOnClickListener(new View.OnClickListener() {
            @SuppressLint("ResourceAsColor")
            public void onClick(View v) {
                Toast.makeText(Bluetooth_RMU_MP.this, "Saved", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Bluetooth_RMU_MP.this, UploadAll.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                finish();
