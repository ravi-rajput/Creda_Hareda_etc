...
public class  DeviceLIst_MP extends AppCompatActivity {
    Button btnPaired;
    ListView devicelist;
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("स्वयं करें !", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent manualintent= new Intent(getApplicationContext(), RMU_MP.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_list__mp);
        getSupportActionBar().setTitle("Pump Installation  MP");
        //Calling widgets
        btnPaired = (Button)findViewById(R.id.buttonmd);
        devicelist = (ListView)findViewById(R.id.listViewmd);
    ...
    private AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick (AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            Intent ip = new Intent(DeviceLIst_MP.this, Bluetooth_RMU_MP.class);
