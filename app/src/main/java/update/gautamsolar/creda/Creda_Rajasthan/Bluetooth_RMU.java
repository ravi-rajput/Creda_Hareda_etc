...
public class Bluetooth_RMU extends AppCompatActivity {
    ...
    private Bluetooth_RMU.ConnectedThread mConnectedThread;
    ...
    String eng_id,sregnnumber, sbenifname, sfname, scontact, svillage, sblock, spumpType, old_rmu;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bluetooth__rmu);
        getSupportActionBar().setTitle("CREDA RAJASTHAN");
        constants= new Constants();

        settings = PreferenceManager.getDefaultSharedPreferences(this);
        eng_id=settings.getString("eng_id","");
        ...
        Localdialog = new Dialog(Bluetooth_RMU.this); // Context, this, etc.
        dialog = new Dialog(Bluetooth_RMU.this); // Context, this, etc.
        ...
        NewRmuNou = (EditText) findViewById(R.id.textrmunonewublurj);
        NewRmuNou.setFocusable(false);
        RmuimageOneU = (ImageView) findViewById(R.id.imagermu_oneublurj);
        new Bluetooth_RMU.ConnectBT().execute(); //Call the class to connect
        sensorView0 = (TextView) findViewById(R.id.sensorView0ublurj);
        location = findViewById(R.id.textublurj);
        send = findViewById(R.id.sendublurj);
        ...
        mRecyclerView = findViewById(R.id.recycler_listublurj);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ConnectivityManager cm = (ConnectivityManager) Bluetooth_RMU.this.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//                        savelocal(device_id);
                        ...
                        e.printStackTrace();
                        Toast.makeText(Bluetooth_RMU.this, "ERROR", Toast.LENGTH_SHORT).show();
                    }
                ...
                try {
                    ...
                    if (message.equals("false")) {
                        ...
                        dialog.findViewById(R.id.clickmedismiss).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent i = new Intent(Bluetooth_RMU.this, UploadAll.class);
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(Bluetooth_RMU.this);
                    }
                })
