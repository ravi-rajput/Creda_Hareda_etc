...
public class RMU_Rajasthan_Self extends AppCompatActivity {
    ...
    String rmu_rj_api,eng_id, sregnnumber, sbenifname, sfname, scontact, svillage, sblock, spumpType, old_rmu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmu__rajasthan__self);
        constants = new Constants();
        rmu_rj_api=constants.RMU_API;
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        eng_id=sharedPreferences.getString("eng_id","");
        getSupportActionBar().setTitle("CREDA RAJASTHAN");
        BenificiaryName = (TextView) findViewById(R.id.benificiaryide);
        Block = (TextView) findViewById(R.id.blockide);
        RmuSpinner = (Spinner) findViewById(R.id.selectprefixrmuRJ);
        ...
        NewRmuNo = (EditText) findViewById(R.id.textrmunonewRJ);


        RmuimageOne = (ImageView) findViewById(R.id.imagermu_oneRJ);
        RmuImage = (LinearLayout) findViewById(R.id.rmu_image_clickRJ);
        settings = PreferenceManager.getDefaultSharedPreferences(this);
        prefsEditor = settings.edit();
        Localdialog = new Dialog(RMU_Rajasthan_Self.this); // Context, this, etc.
        dialog = new Dialog(RMU_Rajasthan_Self.this); // Context, this, etc.
        ...
        UPLOAD = (Button) findViewById(R.id.senduuRJ);
        ...
        NewRmuNo.setText(settingss.getString("rmu_no", ""));
        ...
        UPLOAD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (NewRmuNo.getText().toString().equals("")) {
                    ...
                    ConnectivityManager cm = (ConnectivityManager) RMU_Rajasthan_Self.this.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        Toast.makeText(getApplicationContext(),dateupload,Toast.LENGTH_LONG).show();
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(RMU_Rajasthan_Self.this);
                    }
                })
    ...
    public void UploadRmu(String Api_Rmu) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, rmu_rj_api, new Response.Listener<String>() {
            @Override
                    ...
                    if (message.equals("false")) {
                        ...
                        dialog.findViewById(R.id.clickmedismiss).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Toast.makeText(RMU_Rajasthan_Self.this, "Saved", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(RMU_Rajasthan_Self.this, UploadAll.class);
...
/*
    ...
    public void save_local() {
        ...
        Rmu_Table_Rajasthan rmu_table_rajasthan = new Rmu_Table_Rajasthan();
        rmu_table_rajasthan.fotoRMu = String.valueOf(photormu);
        rmu_table_rajasthan.NewRMuNO = String.valueOf(rmunewnumber);
        rmu_table_rajasthan.regn_no_rmu = String.valueOf(sregnnumber);
        rmu_table_rajasthan.latrmu = lat;
        rmu_table_rajasthan.eng_id=eng_id;
        rmu_table_rajasthan.lonrmu = lon;
        rmu_table_rajasthan.datetime = getDateTime();
        rmu_table_rajasthan.save();
