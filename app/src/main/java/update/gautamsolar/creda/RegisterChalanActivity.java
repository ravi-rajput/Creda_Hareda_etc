...
public class RegisterChalanActivity extends AppCompatActivity {
    TextView Father, Contactid, Villageide, Pumpide, Contactide, Blockid,numberid;
    String api,saralId,reg_no, regnnumber="", benifname="", fathername="", contact="", block="", village="",eng_id,KEYPHOTO1="";
    ImageView imagefound_one;
    EditText saral_no;
    SharedPreferences sharedPreferences;
    Button btnfoundation_upload;
    LinearLayout reg_no_layout;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_chalan_register);

        Father = (TextView) findViewById(R.id.fatheride);
        detail_card = (CardView) findViewById(R.id.detail_card);
        reg_no_layout = (LinearLayout) findViewById(R.id.reg_no_layout);
        saral_no = (EditText) findViewById(R.id.saralNo);
        ...
        if(bundlef!=null) {
            ...
            saralId = bundlef.getString("saralid");
            saral_no.setText(saralId);
            detail_card.setVisibility(View.VISIBLE);
            reg_no_layout.setVisibility(View.VISIBLE);
            api = "update_chalan_v1.php";
        }
        else{
            api = "register_chalan_v1.php";
            detail_card.setVisibility(View.GONE);
            reg_no_layout.setVisibility(View.GONE);
        }
...
//            imagefound_one.setBackgroundResource(R.mipmap.tickclick);
        ...
        dialog = new Dialog(RegisterChalanActivity.this); // Context, this, etc.
        Localdialog = new Dialog(RegisterChalanActivity.this); // Context, this, etc.
...
//        }
        ...
        btnfoundation_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ConnectivityManager cm = (ConnectivityManager) RegisterChalanActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    NetworkCapabilities capabilities = cm.getNetworkCapabilities(cm.getActiveNetwork());
                    if (capabilities != null) {
                        //if connected to wifi or mobile data plan
                        if(!TextUtils.isEmpty(saral_no.getText().toString())){
                            uploaduserimage1();
                        }else{
                            Toast.makeText(RegisterChalanActivity.this, "Please Enter Saral No", Toast.LENGTH_SHORT).show();
                        }

//                        uploadVideo();
                    }else {
                        Toast.makeText(RegisterChalanActivity.this, "Internet Not Access", Toast.LENGTH_SHORT).show();
//                        save_local();
                    }                }
                else {
                    if (cm != null) {
...
//                            save_local();
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(RegisterChalanActivity.this);
                    }
                })
    ...
    public void save_local() {
        ...
        Localdialog.findViewById(R.id.clickmedismissf).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RegisterChalanActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(RegisterChalanActivity.this, UploadAll.class);
...
//        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://gautamsolar.co.in/pumpall_api/"+api, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (message.equals("false")) {
                        ...
                        dialog.findViewById(R.id.clickmedismiss).setOnClickListener(new View.OnClickListener() {
                            @SuppressLint("ResourceAsColor")
                            public void onClick(View v) {
                                Intent i = new Intent(RegisterChalanActivity.this, ChalanActivity.class);
                                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(i);
                                finish();
                                dialog.dismiss();
...
//                params.put("lon", String.valueOf(longi));
                ...
                params.put("saral_no", saral_no.getText().toString());
