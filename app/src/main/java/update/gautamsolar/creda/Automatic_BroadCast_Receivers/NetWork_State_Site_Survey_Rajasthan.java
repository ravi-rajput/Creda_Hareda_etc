...
public class NetWork_State_Site_Survey_Rajasthan extends BroadcastReceiver {
...
//       }
        ...
        if (activeNetwork != null) {
            ...
            if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI ||
                ...
                List<Site_Survey_Table_Rajasthan> instalmodel = getSurvey();
                for (int i = 0; i < instalmodel.size(); i++) {
                    Site_Survey_Table_Rajasthan site_survey_table_rajasthan = instalmodel.get(i);

                    Surveyload(site_survey_table_rajasthan.foto1, site_survey_table_rajasthan.foto2, site_survey_table_rajasthan.foto3, site_survey_table_rajasthan.foto4, site_survey_table_rajasthan.boredepth, site_survey_table_rajasthan.boresize, site_survey_table_rajasthan.waterlevel, site_survey_table_rajasthan.borestatus, site_survey_table_rajasthan.exstmotorstring, site_survey_table_rajasthan.Lat, site_survey_table_rajasthan.Lon, site_survey_table_rajasthan.Regn, site_survey_table_rajasthan.Dati,site_survey_table_rajasthan.eng_id);
    ...
    private void Surveyload(final String photo1, final String photo2, final String photo3, final String photo4, final String boredepth, final String boresize, final String waterlevel,
                            final String bore_status, final String existing_motor_string, final String lat, final String lon,
                            final String reg_no, final String datetime, final String eng_id) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, constants.SITE_SURVEY_API,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            try{
                                ...
                                new Delete().from(Site_Survey_Table_Rajasthan.class).where("Regn =" + reg_no).execute();
                                Toast.makeText(context, "Site Survey Rajasthan Upload Successfully", Toast.LENGTH_SHORT).show();
                            }catch (Exception ae){
                            }
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(context, "Site Survey Upload failed", Toast.LENGTH_LONG).show();
    ...
    public List<Site_Survey_Table_Rajasthan> getSurvey() {
        //Getting all items stored in Inventory table
        return new Select()
                .from(Site_Survey_Table_Rajasthan.class)
                .execute();
    }
