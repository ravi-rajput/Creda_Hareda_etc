...
public class Rmu_Details extends AppCompatActivity {
    ...
    Bitmap bitmap1 = null;
    Spinner RmuSpinner;
    String eng_id,photormu, Rmu_api, Engineer_Contact;
    SharedPreferences settings;
    Button send, UPLOAD;
    EditText NewRmuNo;
    SharedPreferences sharedPreferences;
    private static String imageStoragePathS;
    String sregnnumber, sbenifname, sfname, scontact, svillage, sblock, spumpType, old_rmu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewRmuNo = (EditText) findViewById(R.id.textrmunonew);


        RmuimageOne = (ImageView) findViewById(R.id.imagermu_one);
        RmuImage = (LinearLayout) findViewById(R.id.rmu_image_click);
        settings = PreferenceManager.getDefaultSharedPreferences(this);
        prefsEditor = settings.edit();
        Localdialog = new Dialog(Rmu_Details.this); // Context, this, etc.
        dialog = new Dialog(Rmu_Details.this); // Context, this, etc.
        ...
        UPLOAD = (Button) findViewById(R.id.senduu);
        ...
        UPLOAD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (NewRmuNo.getText().toString().equals("")) {
                    ...
                    ConnectivityManager cm = (ConnectivityManager) Rmu_Details.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                    final NetworkInfo activeNetwork = cm.getActiveNetworkInfo();
                    if (activeNetwork != null) {
                        Constants constants= new Constants();

                        UploadRmu(constants.RMU_API);
                    } else {
                        save_local();
                    }
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(Rmu_Details.this);
                    }
                })
                    ...
                    if (message.equals("false")) {
                        ...
                        dialog.findViewById(R.id.clickmedismiss).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Toast.makeText(Rmu_Details.this, "Saved", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(Rmu_Details.this, UploadAll.class);
...
/*
    ...
    public void save_local() {
        ...
        rmu_Table.NewRMuNO = String.valueOf(rmunewnumber);
